 ...
 * take turns dropping colored discs into a vertically suspended grid. The game
...
public class ConnectFour {
     ...
     * Boolean flag for turn control, true if it's Red's turn.
     */
    ...
    /**
     * Boolean flag to keep the game running
     */
    ...
    /**
     * Initializes the board with empty spaces indicating
     */
    ...
    private void processTurn() {
        boolean validPlay = false;   // Checks if a valid input has been provided by the user
        do {
            if (isRedTurn) {
     ...
     * @return false immediately if any empty cell is found
